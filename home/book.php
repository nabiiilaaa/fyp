...
<div class="txt-heading"><h2 style="font-weight: bold;"><?php echo $book_array[$key]["Code"]. " - " .$book_array[$key]["Name"]; ?></h2></div>
                            ...
                            <table class="book-detail-table">
                                <tbody>
                                    <tr class="book-detail-table-row">
                                        <td rowspan="7" style="width: 20%; background-position: center; background-repeat: no-repeat; background-size: contain; background-image: url('/ReadersZone/wwwroot/book/images/<?php echo $book_array[$key]["ImageLoc"]; ?>');"></td>
                                    ...
                                    <tr class="book-detail-table-row" height="1">
                                        ...
                                        <td class="book-detail-values active-pink-4"><?php if($rating > 0) {
                                            $review = $db_handle->userReview($_SESSION['UserId'], $book_array[$key]["Id"], null);
                                            echo '<input id="review" class="form-control" value="'.$review.'" type="text" onkeyup="updateReview(' . $_SESSION['UserId'] . ', ' . $book_array[$key]["Id"] . ', document.getElementById(\'review\').value);">';
                                        } ?></td>
                                    </tr>
                                </tbody>
                            </table>
                            <input type='button' value='Read' class='btnAction' onclick="location.href='book_read.php?Id=<?php echo $book_array[$key]['Id']; ?>';"/>
                            <input type='button' value='Show  Reviews' class='btnAction' onclick="location.href='reviews.php?Id=<?php echo $book_array[$key]['Id']; ?>';"/>
                            <input type='button' value='Add to Marketplace' class='btnAction' onclick="location.href='addToMarket.php?Id=<?php echo $book_array[$key]['Id']; ?>';"/>
                            <?php if($rating > 0) {
    ...
    <div class="txt-heading" style="font-weight: bold;">Recommended For You</div>
